...
public class CreditCard {
    ...
    // Completed: Credit card's owner. For detailed hint, please see User class
    ...
    // Completed: Credit card's balance history. It is a requirement that the dates in the balanceHistory
